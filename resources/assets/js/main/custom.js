    ...
    /*==============================
        ...
        $('#contact-form').submit(function(){
         ...
         $("#message").slideUp(750,function() {
           ...
           $('#submit') .attr('value','processing..........').attr('disabled','disabled');
           ...
           $.post("/api/contactMessage", {
            ...
            var html= "<fieldset> <div id='success_page'><h1>Email Sent Successfully.</h1><p>Thank you <strong>"+name;
            html+="<strong> ,your message has been submitted to us.</p>"
            messageDiv.html(html)
            messageDiv.slideDown('slow');
            $('#submit').attr("value","Send Message").removeAttr('disabled');
            $('#contact-form').show('slow').trigger("reset");
            ...
            if (!errorMessages) {
              errorText="<p>Something went wrong on the server! </p>";
            }else{
              $.each(errorMessages,function(name,errorMessage){
                errorText+="<p>"+errorMessage[0]+"</p>";
              });
            }
            $('#submit').attr("value","Please Retry Again !").removeAttr('disabled');

            errorText='<div class="error_message">'+errorText+"</div>";
            messageDiv.html(errorText).slideDown('show');
          });
